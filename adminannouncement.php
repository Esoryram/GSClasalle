...
.card-icon { font-size: 22px; opacity: 0.7; margin-bottom: 10px; color:#1f9158; }
.card-value { font-weight: 600; font-size: 16px; margin-bottom: 5px; color:#275850; }
.card-label { font-size: 14px; color:#555; margin-bottom: 10px; }
...
.update-btn { background-color: #0d6efd; color: white; }
.update-btn:hover { background-color: #084298; }
